    ...
    ex: [
      {
        ...
        meta: '5 × (45 s D + 45 s G) · récup 45 s · tous les jours',
        sets: 5, hold: 45, rest: 45, perSide: true, sideRest: 45,
        setup: 'Debout sur UNE jambe, avant-pied au sol ou sur la marche, main au mur pour l\'équilibre. On fait la jambe droite puis la gauche.',
        cue: 'Monte sur la pointe à mi-hauteur et tiens la position, immobile, en respirant.',
        tempo: ['Maintien 45 s / jambe', 'Récup 45 s'],
        what: '« Isométrique » = contracter sans bouger. Souvent un effet antalgique immédiat. Genou tendu = gastrocnémien. Comme les deux tendons sont touchés, on tient sur chaque jambe : 45 s à droite, 45 s à gauche, puis 45 s de récup.',
        how: [
          'Debout sur une jambe, main au mur pour l\'équilibre',
          'Monte sur la pointe à mi-hauteur',
          'Tiens 45 s immobile (jambe droite)',
          'Enchaîne 45 s sur la jambe gauche',
          'Récup 45 s, puis recommence — 5 tours',
        ],
      ...
      },
      {
        ...
        meta: '3 × (30 s D + 30 s G) · récup 30 s · soléaire',
        sets: 3, hold: 30, rest: 30, perSide: true, sideRest: 30,
        setup: 'Même chose sur UNE jambe, mais genou fléchi à ~30° et maintenu fléchi pendant tout le maintien. Droite puis gauche.',
        cue: 'Monte sur la pointe genou plié et tiens. Ça brûle plus bas dans le mollet : c\'est le soléaire.',
        tempo: ['Genou fléchi ~30°', 'Maintien 30 s / jambe', 'Récup 30 s'],
        what: 'Genou fléchi = soléaire, le muscle qui encaisse l\'essentiel de la charge en montée en trail. Aussi important que le gastrocnémien — ne le saute jamais. 30 s à droite, 30 s à gauche, 30 s de récup.',
        how: [
          'Debout sur une jambe, genou fléchi à ~30°, main au mur',
          'Monte sur la pointe en gardant le genou plié',
          'Tiens 30 s immobile (jambe droite)',
          'Enchaîne 30 s sur la jambe gauche',
          'Récup 30 s — 3 tours',
        ],
